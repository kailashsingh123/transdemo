    ...
    return (
        ...
        {/* <div className='overflow-hidden relative mix-blend-overlay'> */}
         ...
         <div className='bg-green-500'>
          <h1 className=' text-center py-10 text-4xl font-bold text-blue-950 '>Securing People</h1>
         </div>
